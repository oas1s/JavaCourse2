...
public class StreamMain {
    ...
    public static void main(String[] args) {
        ...
        // limit
        List<Integer> top = balances.stream().limit(5).toList();
        ...
        users.stream().sorted((u1,u2) -> u1.balance.compareTo(u2.balance)).limit(5).forEach(u -> System.out.println(u.balance));
//        Map<Integer,List<Student>> map = students.stream().collect(Collectors.groupingBy(s -> s.age));
        // Azat 24
        // Mert 21
        // Evgeniya 19
        // Rezeda 19
